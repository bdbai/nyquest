...
impl WinHttpAsyncResponse {
    ...
    fn start_query_data(&self) -> NyquestResult<()> {
        ...
        let result =
            unsafe { WinHttpQueryDataAvailable(request_handle, std::ptr::null_mut()) };
        if result == 0 {
    ...
    fn poll_read(
        ...
        match this.ctx.state() {
            ...
            RequestState::HeadersReceived => {
                ...
                if this.ctx.transition_state_no_wake(RequestState::HeadersReceived, RequestState::QueryingData) {
            ...
            RequestState::DataAvailable => {
                ...
                if this.ctx.transition_state_no_wake(RequestState::DataAvailable, RequestState::Reading) {
